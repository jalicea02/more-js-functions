...
// TO DO
function addTheValues(arg1, arg2){
    if(isNaN(arg1) || isNaN(arg2)){
        addToPage(arg1 + " " + arg2);
    }
    else{
        addToPage("Both arguments are numbers. When added the result is: " + (arg1 + arg2));
    }
}
...
addTheValues(10, 24);
addTheValues("Spaghetti", "Carbonara");
addTheValues(5, "Golden Rings");
addTheValues("Spider-Man", 2);
...
function scopeExample (){
    let localVariable = "This is a local variable from the scopeVariable Function";
...
addToPage(doubleMyNumberArrow(25));
